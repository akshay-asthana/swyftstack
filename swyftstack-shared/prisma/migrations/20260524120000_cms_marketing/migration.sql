...
CREATE INDEX "cms_marketing_pages_status_idx" ON "cms_marketing_pages" ("status");
CREATE INDEX "cms_marketing_pages_type_idx" ON "cms_marketing_pages" ("type");
CREATE INDEX "cms_marketing_pages_published_at_idx" ON "cms_marketing_pages" ("published_at");
CREATE INDEX "cms_marketing_pages_slug_idx" ON "cms_marketing_pages" ("slug");
