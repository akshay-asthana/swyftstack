    ...
    <UserShell user={user} organizationName={org?.name}>
      <div className="page-head">
        <div>
          ...
          <p className="sub" style={{ marginBottom: 0 }}>Everything you need to ship on Swyftstack.</p>
        </div>
      ...
      <div className="split-even">
        <div className="guide">
          ...
          <ol className="small">
            ...
            <li>Swyftstack queues a deployment, builds it, and assigns it to an available app node.</li>
          </ol>
        </div>
